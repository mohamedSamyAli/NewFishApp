            ...
            <div className="content__wrapper">
                <div className="collapsable__Sections">
                    <Collapse className="checkbox__collapsable-groups" activeKey={['1', '2', '3', '4', '5', '6', '7']} >
                        <Panel  header="بيانات المستاجر" key='1'>
                            <Item
                        ...
                        <Panel  header="بيانات القطعه المؤجره" key='2'>
                            <Item
                        ...
                        <Panel  header="بيانات عامه عن العقد" key='3'>
                            <Item
                        ...
                        <Panel  header="التأمين" key='4'>
                            <InsuranceData />
                        </Panel>
                        <Panel  header="المبلغ الذى تم تسديده" key='5'>
                            <PaidMony />
                        </Panel>
                        <Panel  header="الأموال المستحقه وغرامة التأخير" key='6'>
                            <DeservedMony />
                        </Panel>
                        <Panel  header="قرارات إداريه" key='7'>
                            <Decision />
                        </Panel>
                    </Collapse>
                </div>
